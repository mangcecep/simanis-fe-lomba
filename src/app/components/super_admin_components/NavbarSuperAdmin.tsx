...
const NavbarSuperAdminComponents = () => {
    ...
    switch (location.pathname) {
        case '/super_admin/dashboard':
            ...
            break;
        case '/super_admin/inventory':
            navbarTitlePage = 'Data Inventaris'
            break;
        case '/super_admin/manage_account':
            navbarTitlePage = 'Kelola Akun'
            break;
        case '/super_admin/borrowed':
            navbarTitlePage = 'Peminjaman'
            break;
        case '/super_admin/archive':
...
export default NavbarSuperAdminComponents