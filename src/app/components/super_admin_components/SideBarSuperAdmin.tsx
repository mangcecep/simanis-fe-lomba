...
const MenuLinks = [
    {href: '/super_admin/dashboard', label: 'Dashboard', icon: DashboardSquare02Icon},
    {href: '/super_admin/inventory', label: 'Data Inventaris', icon: Package02Icon},
    {href: '/super_admin/manage_account', label: 'Kelola akun', icon: UserGroupIcon},
    {href: '/super_admin/borrowed', label: 'Peminjaman', icon: ScanIcon},
    {href: '/super_admin/archive', label: 'Arsip', icon: Archive03Icon},
]

const SideBarSuperAdminComponents = () => {
...
export default SideBarSuperAdminComponents