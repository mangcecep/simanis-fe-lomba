...
import { PackageAddIcon, Search } from '@hugeicons/core-free-icons'

const InventorySuperAdminPage = () => {
  return (
        ...
        <section className="flex-1 min-h-0 overflow-y-auto">
          <div className="top-main flex flex-col">
            ...
            <div className="category-button bg-[#FFFFFF] flex items-center justify-between p-4 border-b border-[#d2d2d2]">
              ...
              <div className="right">
                <button type='button' className="flex items-center gap-2 bg-normal-yellow px-6 py-2 rounded-full text-[#FFFFFF] cursor-pointer hover:bg-normal-hover-yellow transition-all duration-200">Tambah Barang <HugeiconsIcon icon={PackageAddIcon} size={20}/></button>
              </div>
            </div>
          </div>
...
export default InventorySuperAdminPage