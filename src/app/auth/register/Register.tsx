import { ArrowRight02Icon, Building03Icon, Location03Icon, LockPasswordIcon, Mail02Icon, PackageIcon, PhoneCall, School01Icon, User02Icon, ViewIcon, ViewOffFreeIcons } from '@hugeicons/core-free-icons'
          ...
          <div className="form-input flex flex-col gap-2">
            ...
            <div className="wrapper-input-group flex flex-col gap-1">
              <div className="wrapper flex gap-2">
                <div className="input-group flex flex-col w-full">
                  <label className="text-[12px] text-[#000000] font-semibold tracking-[.15em]">NAMA INSTANSI / SEKOLAH</label>
                  <div className="wrapper-input flex gap-2 items-center w-full border-2 px-3 py-1.5 rounded hover:border-[#001d74] focus-within:border-[#001d74] transition-all duration-300">
                    <span><HugeiconsIcon icon={School01Icon} size={24} className="text-[#646464]"/></span>
                    <input type="text" name="school_name" id="schoolName" placeholder='Masukkan nama sekolah anda' className="outline-none w-full text-[14px] text-[#000000] placeholder:text-[#a7a7a7]"/>
                  </div>
                </div>
                <div className="input-group flex flex-col w-full">
                  <label className="text-[12px] text-[#000000] font-semibold tracking-[.15em]">NAMA PERUSAHAAN</label>
                  <div className="wrapper-input flex gap-2 items-center w-full border-2 px-3 py-1.5 rounded hover:border-[#001d74] focus-within:border-[#001d74] transition-all duration-300">
                    <span><HugeiconsIcon icon={Building03Icon} size={24} className="text-[#646464]"/></span>
                    <input type="text" name="company_name" id="companyName" placeholder='Masukkan nama perusahaan anda' className="outline-none w-full text-[14px] text-[#000000] placeholder:text-[#a7a7a7]"/>
                  </div>
                </div>
              </div>
            ...
            <div className="input-group flex flex-col">
              ...
              <div className="wrapper-input relative flex gap-2 items-center w-full border-2 px-3 py-1.5 rounded hover:border-[#001d74] focus-within:border-[#001d74] transition-all duration-300">
                ...
                <button type='button' onClick={() => setShowPassword(!showPassword)} className="absolute right-2 top-1/2 -translate-y-1/2 hover:text-[#001d74] cursor-pointer transition-all duration-300">{showPassword ? <HugeiconsIcon icon={ViewOffFreeIcons} size={22}/> : <HugeiconsIcon icon={ViewIcon} size={22}/>}</button>
              </div>
            </div>
          </div>
          <div className="btn-submit">
            <button type='button' className="flex items-center gap-1 text-[16px] bg-[#001d74] text-[#FFFFFF] w-full justify-center px-4 py-2 cursor-pointer rounded hover:bg-[#001556] transition-all duration-300">Masuk <HugeiconsIcon icon={ArrowRight02Icon} size={22}/></button>
          </div>
